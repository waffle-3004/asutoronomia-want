...
public class PostInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView postImage = findViewById(R.id.postImage11);
        ImageView notificationImage = findViewById(R.id.notificationImage11);
        ImageView mypageImage = findViewById(R.id.mypageImage11);
